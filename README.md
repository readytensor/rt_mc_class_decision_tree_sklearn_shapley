# Decision Tree Multiclass Classifier in Scikit-Learn with Shapley Explanations
...
- A **Decision Tree Multiclass Classifier** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Decision Tree Multiclass Classifier model implemented using **Scikit-Learn** library.
